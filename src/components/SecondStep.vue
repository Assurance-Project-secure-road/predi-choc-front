        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default" id="cat_veh" v-model="catVehicule">
                    ...
                    <option
                        value="3"
                    >Voiturette (Quadricycle à moteur carrossé) (anciennement "voiturette ou tricycle à moteur")</option>
            ...
            <div class="mb-3">
                <label
                    for="motor_veh"
                    class="form-label"
                >Quelle est la motorisation de votre véhicule ?</label>
                <select
                    class="form-select"
                    aria-label="Default"
                    id="motor_veh"
                    v-model="typeMotorVeh"
                >
            ...
            <div class="mb-3">
                <label
                    for="cat_route"
                    class="form-label"
                >Quelle route avez-vous l’habitude d’emprunter ?</label>
                <select
                    class="form-select"
                    aria-label="Default"
                    id="cat_route"
